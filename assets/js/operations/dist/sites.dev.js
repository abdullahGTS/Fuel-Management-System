    ...
    return regeneratorRuntime.async(function init$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return regeneratorRuntime.awrap((0, _constant.fetchData)(_constant.API_PATHS.siteSuddenLoss));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 5;
            return regeneratorRuntime.awrap(SitesOperationDT.fetchData());
          ...
          case 9:
            if (sites && sites.length > 0) {
              formattedData = SitesOperationDT.transformData(sites);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            _context3.next = 6;
            return regeneratorRuntime.awrap(_script.DataTable.fetchData(response.sites));

          case 6:
            sites = _context3.sent;
            return _context3.abrupt("return", sites);

          case 10:
            _context3.prev = 10;
            _context3.t0 = _context3["catch"](0);
            console.error("Error fetching SitesOperationDT data:", _context3.t0);
...
var SiteList = {
  init: function init() {
    var wrapper, data, totalSites, siteListWrapper, filterInput;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 10:
            ...
            if (totalSites) totalSites.textContent = Object.keys(data.sites).length; // Get the site list wrapper
...
var SiteDrawer = {
  ...
  siteDetails: function siteDetails(drawer, site) {
    ...
    return regeneratorRuntime.async(function siteDetails$(_context5) {
      while (1) {
...
var RateLimit = {
  init: function init() {
    var highRate, lowRate, response;
    return regeneratorRuntime.async(function init$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            highRate = document.querySelector('#highRate');
            lowRate = document.querySelector('#lowRate');
            _context6.next = 4;
            return regeneratorRuntime.awrap(FetchData.init());
...
var RateForm = {
  ...
  createRateForm: function createRateForm(selectedSite) {
    var rateForm = document.querySelector('#rateForm');
    var currentRate = selectedSite.rate; // Create the gts-card-title element

    var cardTitle = document.createElement('div');
    cardTitle.classList.add('gts-card-title');
    cardTitle.innerHTML = "\n            <div class=\"gts-card-title-wrapper\">\n                <span class=\"mat-icon material-symbols-sharp\">waterfall_chart</span>\n                <h3>Adjust Delivery Rate For Site #".concat(selectedSite.sitenumber, "</h3>\n            </div>\n        "); // Create the form element
  ...
  emptyState: function emptyState(wrapper) {
    if (!wrapper.querySelector(".emptyState")) {
      ...
      var heading = document.createElement("h3");
      heading.textContent = "Select Site"; // Create the brief (p)

      var brief = document.createElement("p");
      brief.textContent = "Select site to be able set new rate"; // Append heading and brief to the empty state div
